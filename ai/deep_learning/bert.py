...
Original file is located at
    https://colab.research.google.com/drive/1W3FoYLbZWkrfF76x3pxEGERPZYZtf186
"""
...
# Load data
data, labels = load_data("../../data/processed/zemberek-30k.txt", group=False, group_size=2, unique=True)
